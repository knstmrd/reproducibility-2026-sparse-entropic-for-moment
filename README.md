...
- [`sod_dvm.jl`](Sod shock tube simulated using DVM)
- [`sod_speqck.jl`](Sod shock tube simulated using the sparse entropic quadrature method)
- [`couette_dvm.jl`](Couette flow simulated using DVM)
- [`couette_speqck.jl`](Couette flow simulated using the sparse entropic quadrature method)
